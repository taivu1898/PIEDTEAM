...
có thể cho Herbivore tham gia hội StudyEnthusiasts ko ? không
code đc nhưng ko làm vì code vậy thì con bò cx sẽ ham học thì sao ?
=> nên cho từng class con phù hợp tham gia hội StudyEnthusiasts

Kế thừa thì là đơn kế thừa còn clb là đa kế thừa(cái cớ)
*/
package data;
